                        ...
                        if ($scope.dati.listaUtenti[i].buddista === 'Sì') {
                           ...
                           // var si=false;
                            ...
                            person[$scope.dati.listaUtenti[i].$id].$loaded().then(function (personPar) {
                                ...
                                $scope.dati.vm.positions.push({lat: lat[personPar.$id], lng: lng[personPar.$id],
                                    name: person[personPar.$id].name, surname: person[personPar.$id].surname, id:person[personPar.$id].$id} );
